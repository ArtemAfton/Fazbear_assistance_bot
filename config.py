HOME_DIR = '/home/student/Fazbear_assistance_bot'  # путь к папке с проектом
...
SYSTEM_PROMPT = [{'role': 'system', 'text': 'Ты доброжелательный собеседник. Общайся с пользователем на "ты".'}]  # список с системным промтом